...
(function(b,c,d,e){function f(n,x,y){return setTimeout(m(n,y),x)}function g(n,x,y){return Array.isArray(n)?(h(n,y[x],y),!0):!1}function h(n,x,y){var B;if(n)if(n.forEach)n.forEach(x,y);else if(n.length!==e)for(B=0;B<n.length;)x.call(y,n[B],B,n),B++;else for(B in n)n.hasOwnProperty(B)&&x.call(y,n[B],B,n)}function k(n,x,y){var B="DEPRECATED METHOD: "+x+"\n"+y+" AT \n";return function(){var D=Error("get-stack-trace");D=D&&D.stack?D.stack.replace(/^[^\(]+?[\n$]/gm,"").replace(/^\s+at\s+/gm,"").replace(/^Object.<anonymous>\s*\(/gm,
"{anonymous}()@"):"Unknown Stack Trace";var E=b.console&&(b.console.warn||b.console.log);E&&E.call(b.console,B,D);return n.apply(this,arguments)}}function l(n,x,y){x=x.prototype;var B=n.prototype=Object.create(x);B.constructor=n;B._super=x;y&&Z(B,y)}function m(n,x){return function(){return n.apply(x,arguments)}}function p(n,x){return"function"==typeof n?n.apply(x?x[0]||e:e,x):n}function q(n,x,y){h(t(x),function(B){"undefined"!=typeof b.addEventListener?n.addEventListener(B,y,!1):n.attachEvent(B,y)})}
function v(n,x,y){h(t(x),function(B){"undefined"!=typeof b.removeEventListener?n.removeEventListener(B,y,!1):n.detachEvent(B,y,!1)})}function r(n,x){for(;n;){if(n==x)return!0;n=n.parentNode}return!1}function t(n){return n.trim().split(/\s+/g)}function u(n,x,y){if(n.indexOf&&!y)return n.indexOf(x);for(var B=0;B<n.length;){if(y&&n[B][y]==x||!y&&n[B]===x)return B;B++}return-1}function w(n){return Array.prototype.slice.call(n,0)}function z(n,x,y){for(var B=[],D=[],E=0;E<n.length;){var H=x?n[E][x]:n[E];
0>u(D,H)&&B.push(n[E]);D[E]=H;E++}y&&(B=x?B.sort(function(N,V){return N[x]>V[x]}):B.sort());return B}function A(n,x){if(x&&x[0]){for(var y,B=x[0].toUpperCase()+x.slice(1),D=0;D<sa.length;){y=(y=sa[D])?y+B:x;if(y in n)return y;D++}return e}}function F(n){n=n.ownerDocument||n;return n.defaultView||n.parentWindow||b}function C(n,x){var y=this;this.manager=n;this.callback=x;this.element=n.element;this.target=n.options.inputTarget;this.domHandler=function(B){p(n.options.enable,[n])&&y.handler(B)};this.init()}
function K(n,x,y){var B=y.pointers.length,D=y.changedPointers.length;var E=x&1&&0===B-D;y.isFirst=!!E;y.isFinal=!!(x&12&&0===B-D);E&&(n.session={});y.eventType=x;x=n.session;B=y.pointers;D=B.length;x.firstInput||(x.firstInput=M(y));1<D&&!x.firstMultiple?x.firstMultiple=M(y):1===D&&(x.firstMultiple=!1);E=x.firstInput;var H=(D=x.firstMultiple)?D.center:E.center;var N=y.center=I(B);y.timeStamp=qa();y.deltaTime=y.timeStamp-E.timeStamp;y.angle=L(H,N);y.distance=O(H,N);E=y.center;H=x.offsetDelta||{};N=
x.prevDelta||{};var V=x.prevInput||{};if(1===y.eventType||4===V.eventType)N=x.prevDelta={x:V.deltaX||0,y:V.deltaY||0},H=x.offsetDelta={x:E.x,y:E.y};y.deltaX=N.x+(E.x-H.x);y.deltaY=N.y+(E.y-H.y);y.offsetDirection=G(y.deltaX,y.deltaY);H=y.deltaTime;E=y.deltaX/H||0;H=y.deltaY/H||0;y.overallVelocityX=E;y.overallVelocityY=H;y.overallVelocity=da(E)>da(H)?E:H;D?(E=D.pointers,E=O(B[0],B[1],oa)/O(E[0],E[1],oa)):E=1;y.scale=E;D?(D=D.pointers,B=L(B[1],B[0],oa)+L(D[1],D[0],oa)):B=0;y.rotation=B;y.maxPointers=
x.prevInput?y.pointers.length>x.prevInput.maxPointers?y.pointers.length:x.prevInput.maxPointers:y.pointers.length;H=x.lastInterval||y;B=y.timeStamp-H.timeStamp;8!=y.eventType&&(25<B||H.velocity===e)?(E=y.deltaX-H.deltaX,H=y.deltaY-H.deltaY,N=E/B||0,V=H/B||0,B=N,D=V,N=da(N)>da(V)?N:V,E=G(E,H),x.lastInterval=y):(N=H.velocity,B=H.velocityX,D=H.velocityY,E=H.direction);y.velocity=N;y.velocityX=B;y.velocityY=D;y.direction=E;x=n.element;r(y.srcEvent.target,x)&&(x=y.srcEvent.target);y.target=x;n.emit("hammer.input",
y);n.recognize(y);n.session.prevInput=y}function M(n){for(var x=[],y=0;y<n.pointers.length;)x[y]={clientX:ha(n.pointers[y].clientX),clientY:ha(n.pointers[y].clientY)},y++;return{timeStamp:qa(),pointers:x,center:I(x),deltaX:n.deltaX,deltaY:n.deltaY}}function I(n){var x=n.length;if(1===x)return{x:ha(n[0].clientX),y:ha(n[0].clientY)};for(var y=0,B=0,D=0;D<x;)y+=n[D].clientX,B+=n[D].clientY,D++;return{x:ha(y/x),y:ha(B/x)}}function G(n,x){return n===x?1:da(n)>=da(x)?0>n?2:4:0>x?8:16}function O(n,x,y){y||
(y=ta);var B=x[y[0]]-n[y[0]];n=x[y[1]]-n[y[1]];return Math.sqrt(B*B+n*n)}function L(n,x,y){y||(y=ta);return 180*Math.atan2(x[y[1]]-n[y[1]],x[y[0]]-n[y[0]])/Math.PI}function J(){this.evEl=Aa;this.evWin=Ba;this.pressed=!1;C.apply(this,arguments)}function Q(){this.evEl=ua;this.evWin=va;C.apply(this,arguments);this.store=this.manager.session.pointerEvents=[]}function U(){this.evTarget="touchstart";this.evWin="touchstart touchmove touchend touchcancel";this.started=!1;C.apply(this,arguments)}function T(){this.evTarget=
Ca;this.targetIds={};C.apply(this,arguments)}function S(n,x){var y=w(n.touches),B=this.targetIds;if(x&3&&1===y.length)return B[y[0].identifier]=!0,[y,y];n=w(n.changedTouches);var D=[],E=this.target;var H=y.filter(function(N){return r(N.target,E)});if(1===x)for(y=0;y<H.length;)B[H[y].identifier]=!0,y++;for(y=0;y<n.length;)B[n[y].identifier]&&D.push(n[y]),x&12&&delete B[n[y].identifier],y++;if(D.length)return[z(H.concat(D),"identifier",!0),D]}function ia(){C.apply(this,arguments);var n=m(this.handler,
this);this.touch=new T(this.manager,n);this.mouse=new J(this.manager,n);this.primaryTouch=null;this.lastTouches=[]}function W(n){n=n.changedPointers[0];if(n.identifier===this.primaryTouch){var x={x:n.clientX,y:n.clientY};this.lastTouches.push(x);var y=this.lastTouches;setTimeout(function(){var B=y.indexOf(x);-1<B&&y.splice(B,1)},2500)}}function ea(n,x){this.manager=n;this.set(x)}function ma(n){if(-1<n.indexOf("none"))return"none";var x=-1<n.indexOf("pan-x"),y=-1<n.indexOf("pan-y");return x&&y?"none":
x||y?x?"pan-x":"pan-y":-1<n.indexOf("manipulation")?"manipulation":"auto"}function P(n){this.options=Z({},this.defaults,n||{});this.id=Da++;this.manager=null;n=this.options.enable;this.options.enable=n===e?!0:n;this.state=1;this.simultaneous={};this.requireFail=[]}function ja(n){return n&16?"cancel":n&8?"end":n&4?"move":n&2?"start":""}function na(n){return 16==n?"down":8==n?"up":2==n?"left":4==n?"right":""}function aa(n,x){return(x=x.manager)?x.get(n):n}function R(){P.apply(this,arguments)}function fa(){R.apply(this,
arguments);this.pY=this.pX=null}function ka(){R.apply(this,arguments)}function ba(){P.apply(this,arguments);this._input=this._timer=null}function X(){R.apply(this,arguments)}function ca(){R.apply(this,arguments)}function la(){P.apply(this,arguments);this.pCenter=this.pTime=!1;this._input=this._timer=null;this.count=0}function Y(n,x){x=x||{};var y=x.recognizers;x.recognizers=y===e?Y.defaults.preset:y;return new ra(n,x)}function ra(n,x){this.options=Z({},Y.defaults,x||{});this.options.inputTarget=this.options.inputTarget||
n;this.handlers={};this.session={};this.recognizers=[];this.oldCssProps={};this.element=n;this.input=new ia(this,K);this.touchAction=new ea(this,this.options.touchAction);wa(this,!0);h(this.options.recognizers,function(y){var B=this.add(new y[0](y[1]));y[2]&&B.recognizeWith(y[2]);y[3]&&B.requireFailure(y[3])},this)}function wa(n,x){var y=n.element;if(y.style){var B;h(n.options.cssProps,function(D,E){B=A(y.style,E);x?(n.oldCssProps[B]=y.style[B],y.style[B]=D):y.style[B]=n.oldCssProps[B]||""});x||(n.oldCssProps=
{})}}function Ea(n,x){var y=c.createEvent("Event");y.initEvent(n,!0,!0);y.gesture=x;x.target.dispatchEvent(y)}var sa=" webkit Moz MS ms o".split(" "),Fa=c.createElement("div"),ha=Math.round,da=Math.abs,qa=Date.now;var Z="function"!==typeof Object.assign?function(n){if(n===e||null===n)throw new TypeError("Cannot convert undefined or null to object");for(var x=Object(n),y=1;y<arguments.length;y++){var B=arguments[y];if(B!==e&&null!==B)for(var D in B)B.hasOwnProperty(D)&&(x[D]=B[D])}return x}:Object.assign;
var xa=k(function(n,x,y){for(var B=Object.keys(x),D=0;D<B.length;){if(!y||y&&n[B[D]]===e)n[B[D]]=x[B[D]];D++}return n},"extend","Use `assign`."),Ga=k(function(n,x){return xa(n,x,!0)},"merge","Use `assign`."),Da=1,Ha=/mobile|tablet|ip(ad|hone|od)|android/i,Ia="ontouchstart"in b;A(b,"PointerEvent");Ia&&Ha.test(navigator.userAgent);var ta=["x","y"],oa=["clientX","clientY"];C.prototype={handler:function(){},init:function(){this.evEl&&q(this.element,this.evEl,this.domHandler);this.evTarget&&q(this.target,
this.evTarget,this.domHandler);this.evWin&&q(F(this.element),this.evWin,this.domHandler)},destroy:function(){this.evEl&&v(this.element,this.evEl,this.domHandler);this.evTarget&&v(this.target,this.evTarget,this.domHandler);this.evWin&&v(F(this.element),this.evWin,this.domHandler)}};var Ja={mousedown:1,mousemove:2,mouseup:4},Aa="mousedown",Ba="mousemove mouseup";l(J,C,{handler:function(n){var x=Ja[n.type];x&1&&0===n.button&&(this.pressed=!0);x&2&&1!==n.which&&(x=4);this.pressed&&(x&4&&(this.pressed=
!1),this.callback(this.manager,x,{pointers:[n],changedPointers:[n],pointerType:"mouse",srcEvent:n}))}});var Ka={pointerdown:1,pointermove:2,pointerup:4,pointercancel:8,pointerout:8},La={2:"touch",3:"pen",4:"mouse",5:"kinect"},ua="pointerdown",va="pointermove pointerup pointercancel";b.MSPointerEvent&&!b.PointerEvent&&(ua="MSPointerDown",va="MSPointerMove MSPointerUp MSPointerCancel");l(Q,C,{handler:function(n){var x=this.store,y=!1,B=n.type.toLowerCase().replace("ms","");B=Ka[B];var D=La[n.pointerType]||
n.pointerType,E="touch"==D,H=u(x,n.pointerId,"pointerId");B&1&&(0===n.button||E)?0>H&&(x.push(n),H=x.length-1):B&12&&(y=!0);0>H||(x[H]=n,this.callback(this.manager,B,{pointers:x,changedPointers:[n],pointerType:D,srcEvent:n}),y&&x.splice(H,1))}});var Ma={touchstart:1,touchmove:2,touchend:4,touchcancel:8};l(U,C,{handler:function(n){var x=Ma[n.type];1===x&&(this.started=!0);if(this.started){var y=w(n.touches);var B=w(n.changedTouches);x&12&&(y=z(y.concat(B),"identifier",!0));y=[y,B];x&12&&0===y[0].length-
y[1].length&&(this.started=!1);this.callback(this.manager,x,{pointers:y[0],changedPointers:y[1],pointerType:"touch",srcEvent:n})}}});var Na={touchstart:1,touchmove:2,touchend:4,touchcancel:8},Ca="touchstart touchmove touchend touchcancel";l(T,C,{handler:function(n){var x=Na[n.type],y=S.call(this,n,x);y&&this.callback(this.manager,x,{pointers:y[0],changedPointers:y[1],pointerType:"touch",srcEvent:n})}});l(ia,C,{handler:function(n,x,y){var B="mouse"==y.pointerType;if(!(B&&y.sourceCapabilities&&y.sourceCapabilities.firesTouchEvents)){if("touch"==
y.pointerType)x&1?(this.primaryTouch=y.changedPointers[0].identifier,W.call(this,y)):x&12&&W.call(this,y);else{if(B)a:{B=y.srcEvent.clientX;for(var D=y.srcEvent.clientY,E=0;E<this.lastTouches.length;E++){var H=this.lastTouches[E],N=Math.abs(D-H.y);if(25>=Math.abs(B-H.x)&&25>=N){B=!0;break a}}B=!1}if(B)return}this.callback(n,x,y)}},destroy:function(){this.touch.destroy();this.mouse.destroy()}});var ya=A(Fa.style,"touchAction"),za=ya!==e,pa=function(){if(!za)return!1;var n={},x=b.CSS&&b.CSS.supports;
"auto;manipulation;pan-y;pan-x;pan-x pan-y;none".split(";").forEach(function(y){n[y]=x?b.CSS.supports("touch-action",y):!0});return n}();ea.prototype={set:function(n){"compute"==n&&(n=this.compute());za&&this.manager.element.style&&pa[n]&&(this.manager.element.style[ya]=n);this.actions=n.toLowerCase().trim()},update:function(){this.set(this.manager.options.touchAction)},compute:function(){var n=[];h(this.manager.recognizers,function(x){p(x.options.enable,[x])&&(n=n.concat(x.getTouchAction()))});return ma(n.join(" "))},
preventDefaults:function(n){var x=n.srcEvent,y=n.offsetDirection;if(this.manager.session.prevented)x.preventDefault();else{var B=this.actions,D=-1<B.indexOf("none")&&!pa.none,E=-1<B.indexOf("pan-y")&&!pa["pan-y"];B=-1<B.indexOf("pan-x")&&!pa["pan-x"];if(D){var H=2>n.distance,N=250>n.deltaTime;if(1===n.pointers.length&&H&&N)return}if(!B||!E)if(D||E&&y&6||B&&y&24)return this.preventSrc(x)}},preventSrc:function(n){this.manager.session.prevented=!0;n.preventDefault()}};P.prototype={defaults:{},set:function(n){Z(this.options,
n);this.manager&&this.manager.touchAction.update();return this},recognizeWith:function(n){if(g(n,"recognizeWith",this))return this;var x=this.simultaneous;n=aa(n,this);x[n.id]||(x[n.id]=n,n.recognizeWith(this));return this},dropRecognizeWith:function(n){if(g(n,"dropRecognizeWith",this))return this;n=aa(n,this);delete this.simultaneous[n.id];return this},requireFailure:function(n){if(g(n,"requireFailure",this))return this;var x=this.requireFail;n=aa(n,this);-1===u(x,n)&&(x.push(n),n.requireFailure(this));
return this},dropRequireFailure:function(n){if(g(n,"dropRequireFailure",this))return this;n=aa(n,this);n=u(this.requireFail,n);-1<n&&this.requireFail.splice(n,1);return this},hasRequireFailures:function(){return 0<this.requireFail.length},canRecognizeWith:function(n){return!!this.simultaneous[n.id]},emit:function(n){function x(D){y.manager.emit(D,n)}var y=this,B=this.state;8>B&&x(y.options.event+ja(B));x(y.options.event);n.additionalEvent&&x(n.additionalEvent);8<=B&&x(y.options.event+ja(B))},tryEmit:function(n){if(this.canEmit())return this.emit(n);
this.state=32},canEmit:function(){for(var n=0;n<this.requireFail.length;){if(!(this.requireFail[n].state&33))return!1;n++}return!0},recognize:function(n){n=Z({},n);p(this.options.enable,[this,n])?(this.state&56&&(this.state=1),this.state=this.process(n),this.state&30&&this.tryEmit(n)):(this.reset(),this.state=32)},process:function(n){},getTouchAction:function(){},reset:function(){}};l(R,P,{defaults:{pointers:1},attrTest:function(n){var x=this.options.pointers;return 0===x||n.pointers.length===x},
process:function(n){var x=this.state,y=n.eventType,B=x&6;n=this.attrTest(n);return B&&(y&8||!n)?x|16:B||n?y&4?x|8:x&2?x|4:2:32}});l(fa,R,{defaults:{event:"pan",threshold:10,pointers:1,direction:30},getTouchAction:function(){var n=this.options.direction,x=[];n&6&&x.push("pan-y");n&24&&x.push("pan-x");return x},directionTest:function(n){var x=this.options,y=!0,B=n.distance,D=n.direction,E=n.deltaX,H=n.deltaY;D&x.direction||(x.direction&6?(D=0===E?1:0>E?2:4,y=E!=this.pX,B=Math.abs(n.deltaX)):(D=0===
H?1:0>H?8:16,y=H!=this.pY,B=Math.abs(n.deltaY)));n.direction=D;return y&&B>x.threshold&&D&x.direction},attrTest:function(n){return R.prototype.attrTest.call(this,n)&&(this.state&2||!(this.state&2)&&this.directionTest(n))},emit:function(n){this.pX=n.deltaX;this.pY=n.deltaY;var x=na(n.direction);x&&(n.additionalEvent=this.options.event+x);this._super.emit.call(this,n)}});l(ka,R,{defaults:{event:"pinch",threshold:0,pointers:2},getTouchAction:function(){return["none"]},attrTest:function(n){return this._super.attrTest.call(this,
n)&&(Math.abs(n.scale-1)>this.options.threshold||this.state&2)},emit:function(n){1!==n.scale&&(n.additionalEvent=this.options.event+(1>n.scale?"in":"out"));this._super.emit.call(this,n)}});l(ba,P,{defaults:{event:"press",pointers:1,time:251,threshold:9},getTouchAction:function(){return["auto"]},process:function(n){var x=this.options,y=n.pointers.length===x.pointers,B=n.distance<x.threshold,D=n.deltaTime>x.time;this._input=n;if(!B||!y||n.eventType&12&&!D)this.reset();else if(n.eventType&1)this.reset(),
this._timer=f(function(){this.state=8;this.tryEmit()},x.time,this);else if(n.eventType&4)return 8;return 32},reset:function(){clearTimeout(this._timer)},emit:function(n){8===this.state&&(n&&n.eventType&4?this.manager.emit(this.options.event+"up",n):(this._input.timeStamp=qa(),this.manager.emit(this.options.event,this._input)))}});l(X,R,{defaults:{event:"rotate",threshold:0,pointers:2},getTouchAction:function(){return["none"]},attrTest:function(n){return this._super.attrTest.call(this,n)&&(Math.abs(n.rotation)>
this.options.threshold||this.state&2)}});l(ca,R,{defaults:{event:"swipe",threshold:10,velocity:.3,direction:30,pointers:1},getTouchAction:function(){return fa.prototype.getTouchAction.call(this)},attrTest:function(n){var x=this.options.direction;if(x&30)var y=n.overallVelocity;else x&6?y=n.overallVelocityX:x&24&&(y=n.overallVelocityY);return this._super.attrTest.call(this,n)&&x&n.offsetDirection&&n.distance>this.options.threshold&&n.maxPointers==this.options.pointers&&da(y)>this.options.velocity&&
n.eventType&4},emit:function(n){var x=na(n.offsetDirection);x&&this.manager.emit(this.options.event+x,n);this.manager.emit(this.options.event,n)}});l(la,P,{defaults:{event:"tap",pointers:1,taps:1,interval:300,time:250,threshold:9,posThreshold:10},getTouchAction:function(){return["manipulation"]},process:function(n){var x=this.options,y=n.pointers.length===x.pointers,B=n.distance<x.threshold,D=n.deltaTime<x.time;this.reset();if(n.eventType&1&&0===this.count)return this.failTimeout();if(B&&D&&y){if(4!=
n.eventType)return this.failTimeout();y=this.pTime?n.timeStamp-this.pTime<x.interval:!0;B=!this.pCenter||O(this.pCenter,n.center)<x.posThreshold;this.pTime=n.timeStamp;this.pCenter=n.center;this.count=B&&y?this.count+1:1;this._input=n;if(0===this.count%x.taps)return this.hasRequireFailures()?(this._timer=f(function(){this.state=8;this.tryEmit()},x.interval,this),2):8}return 32},failTimeout:function(){this._timer=f(function(){this.state=32},this.options.interval,this);return 32},reset:function(){clearTimeout(this._timer)},
...
ra.prototype={set:function(n){Z(this.options,n);n.touchAction&&this.touchAction.update();n.inputTarget&&(this.input.destroy(),this.input.target=n.inputTarget,this.input.init());return this},stop:function(n){this.session.stopped=n?2:1},recognize:function(n){var x=this.session;if(!x.stopped){this.touchAction.preventDefaults(n);var y=this.recognizers,B=x.curRecognizer;if(!B||B&&B.state&8)B=x.curRecognizer=null;for(var D=0;D<y.length;){var E=y[D];2===x.stopped||B&&E!=B&&!E.canRecognizeWith(B)?E.reset():
E.recognize(n);!B&&E.state&14&&(B=x.curRecognizer=E);D++}}},get:function(n){if(n instanceof P)return n;for(var x=this.recognizers,y=0;y<x.length;y++)if(x[y].options.event==n)return x[y];return null},add:function(n){if(g(n,"add",this))return this;var x=this.get(n.options.event);x&&this.remove(x);this.recognizers.push(n);n.manager=this;this.touchAction.update();return n},remove:function(n){if(g(n,"remove",this))return this;if(n=this.get(n)){var x=this.recognizers;n=u(x,n);-1!==n&&(x.splice(n,1),this.touchAction.update())}return this},
on:function(n,x){if(n!==e&&x!==e){var y=this.handlers;h(t(n),function(B){y[B]=y[B]||[];y[B].push(x)});return this}},off:function(n,x){if(n!==e){var y=this.handlers;h(t(n),function(B){x?y[B]&&y[B].splice(u(y[B],x),1):delete y[B]});return this}},emit:function(n,x){this.options.domEvents&&Ea(n,x);var y=this.handlers[n]&&this.handlers[n].slice();if(y&&y.length)for(x.type=n,x.preventDefault=function(){x.srcEvent.preventDefault()},n=0;n<y.length;)y[n](x),n++},destroy:function(){this.element&&wa(this,!1);
this.handlers={};this.session={};this.input.destroy();this.element=null}};Z(Y,{INPUT_START:1,INPUT_MOVE:2,INPUT_END:4,INPUT_CANCEL:8,STATE_POSSIBLE:1,STATE_BEGAN:2,STATE_CHANGED:4,STATE_ENDED:8,STATE_RECOGNIZED:8,STATE_CANCELLED:16,STATE_FAILED:32,DIRECTION_NONE:1,DIRECTION_LEFT:2,DIRECTION_RIGHT:4,DIRECTION_UP:8,DIRECTION_DOWN:16,DIRECTION_HORIZONTAL:6,DIRECTION_VERTICAL:24,DIRECTION_ALL:30,Manager:ra,Input:C,TouchAction:ea,TouchInput:T,MouseInput:J,PointerEventInput:Q,TouchMouseInput:ia,SingleTouchInput:U,
...
100;var p=e*h,q=e*k,v=0,r=0,t=0,u=0;toolBar&&(v=0===toolBar.getTopHeight()?0:toolBar.getTopHeight()+10,r=0===toolBar.getBottomHeight()?0:toolBar.getBottomHeight()+10,t=0===toolBar.getLeftWidth()?0:toolBar.getLeftWidth()+10,u=0===toolBar.getRightWidth()?0:toolBar.getRightWidth()+10);if(p>windowWidth){var w=windowWidth-p-l+h*e*d.parameters.zoomArea.right/100-u;l=-l-h*e*d.parameters.zoomArea.left/100+t}else w=-l-h*e*d.parameters.zoomArea.left/100+t,l=windowWidth-p-l+h*e*d.parameters.zoomArea.right/100-
u;q>windowHeight?(h=windowHeight-q-m+k*e*d.parameters.zoomArea.bottom/100-r,d=-m-k*e*d.parameters.zoomArea.top/100+v):(h=-m-k*e*d.parameters.zoomArea.top/100+v,d=windowHeight-q-m+k*e*d.parameters.zoomArea.bottom/100-r);g=Number.between(g,w,l);f=Number.between(f,h,d);return{x:parseInt(g),y:parseInt(f)}}};this.pinchMoveIn=function(d,e,f){if(!d.parameters.eventCancel&&!d.parameters.zoomming&&f&&f.pointers&&2==f.pointers.length){var g={};g.scale=e;g.tran=d.mathTran(d,f,d.parameters.origin);d.transformSetting(d,
...
q.data[k+1]/255*r.g),q.data[k+2]!=r.b&&(v.data[k+2]=q.data[k+2]/255*r.b));h.putImageData(v,0,0);f.src=g.toDataURL("image/png");void 0!=d&&d(e);f.colorChanged=!0}}catch(u){if(0==c)$(f).on("load",function(){try{e.changeButtonColor(b,!0,d)}catch(w){}})}}}}};
...
(function(b){function c(r,t){var u=(r&65535)+(t&65535);return(r>>16)+(t>>16)+(u>>16)<<16|u&65535}function d(r,t,u,w,z,A){r=c(c(t,r),c(w,A));return c(r<<z|r>>>32-z,u)}function e(r,t,u,w,z,A,F){return d(t&u|~t&w,r,t,z,A,F)}function f(r,t,u,w,z,A,F){return d(t&w|u&~w,r,t,z,A,F)}function g(r,t,u,w,z,A,F){return d(u^(t|~w),r,t,z,A,F)}function h(r,t){r[t>>5]|=128<<t%32;r[(t+64>>>9<<4)+14]=t;var u=1732584193,w=-271733879,z=-1732584194,A=271733878;for(t=0;t<r.length;t+=16){var F=u;var C=w;var K=z;var M=A;
u=e(u,w,z,A,r[t],7,-680876936);A=e(A,u,w,z,r[t+1],12,-389564586);z=e(z,A,u,w,r[t+2],17,606105819);w=e(w,z,A,u,r[t+3],22,-1044525330);u=e(u,w,z,A,r[t+4],7,-176418897);A=e(A,u,w,z,r[t+5],12,1200080426);z=e(z,A,u,w,r[t+6],17,-1473231341);w=e(w,z,A,u,r[t+7],22,-45705983);u=e(u,w,z,A,r[t+8],7,1770035416);A=e(A,u,w,z,r[t+9],12,-1958414417);z=e(z,A,u,w,r[t+10],17,-42063);w=e(w,z,A,u,r[t+11],22,-1990404162);u=e(u,w,z,A,r[t+12],7,1804603682);A=e(A,u,w,z,r[t+13],12,-40341101);z=e(z,A,u,w,r[t+14],17,-1502002290);
w=e(w,z,A,u,r[t+15],22,1236535329);u=f(u,w,z,A,r[t+1],5,-165796510);A=f(A,u,w,z,r[t+6],9,-1069501632);z=f(z,A,u,w,r[t+11],14,643717713);w=f(w,z,A,u,r[t],20,-373897302);u=f(u,w,z,A,r[t+5],5,-701558691);A=f(A,u,w,z,r[t+10],9,38016083);z=f(z,A,u,w,r[t+15],14,-660478335);w=f(w,z,A,u,r[t+4],20,-405537848);u=f(u,w,z,A,r[t+9],5,568446438);A=f(A,u,w,z,r[t+14],9,-1019803690);z=f(z,A,u,w,r[t+3],14,-187363961);w=f(w,z,A,u,r[t+8],20,1163531501);u=f(u,w,z,A,r[t+13],5,-1444681467);A=f(A,u,w,z,r[t+2],9,-51403784);
z=f(z,A,u,w,r[t+7],14,1735328473);w=f(w,z,A,u,r[t+12],20,-1926607734);u=d(w^z^A,u,w,r[t+5],4,-378558);A=d(u^w^z,A,u,r[t+8],11,-2022574463);z=d(A^u^w,z,A,r[t+11],16,1839030562);w=d(z^A^u,w,z,r[t+14],23,-35309556);u=d(w^z^A,u,w,r[t+1],4,-1530992060);A=d(u^w^z,A,u,r[t+4],11,1272893353);z=d(A^u^w,z,A,r[t+7],16,-155497632);w=d(z^A^u,w,z,r[t+10],23,-1094730640);u=d(w^z^A,u,w,r[t+13],4,681279174);A=d(u^w^z,A,u,r[t],11,-358537222);z=d(A^u^w,z,A,r[t+3],16,-722521979);w=d(z^A^u,w,z,r[t+6],23,76029189);u=d(w^
z^A,u,w,r[t+9],4,-640364487);A=d(u^w^z,A,u,r[t+12],11,-421815835);z=d(A^u^w,z,A,r[t+15],16,530742520);w=d(z^A^u,w,z,r[t+2],23,-995338651);u=g(u,w,z,A,r[t],6,-198630844);A=g(A,u,w,z,r[t+7],10,1126891415);z=g(z,A,u,w,r[t+14],15,-1416354905);w=g(w,z,A,u,r[t+5],21,-57434055);u=g(u,w,z,A,r[t+12],6,1700485571);A=g(A,u,w,z,r[t+3],10,-1894986606);z=g(z,A,u,w,r[t+10],15,-1051523);w=g(w,z,A,u,r[t+1],21,-2054922799);u=g(u,w,z,A,r[t+8],6,1873313359);A=g(A,u,w,z,r[t+15],10,-30611744);z=g(z,A,u,w,r[t+6],15,-1560198380);
w=g(w,z,A,u,r[t+13],21,1309151649);u=g(u,w,z,A,r[t+4],6,-145523070);A=g(A,u,w,z,r[t+11],10,-1120210379);z=g(z,A,u,w,r[t+2],15,718787259);w=g(w,z,A,u,r[t+9],21,-343485551);u=c(u,F);w=c(w,C);z=c(z,K);A=c(A,M)}return[u,w,z,A]}function k(r){var t,u="",w=32*r.length;for(t=0;t<w;t+=8)u+=String.fromCharCode(r[t>>5]>>>t%32&255);return u}function l(r){var t,u=[];u[(r.length>>2)-1]=void 0;for(t=0;t<u.length;t+=1)u[t]=0;var w=8*r.length;for(t=0;t<w;t+=8)u[t>>5]|=(r.charCodeAt(t/8)&255)<<t%32;return u}function m(r){return k(h(l(r),
8*r.length))}function p(r,t){var u=l(r),w=[],z=[];w[15]=z[15]=void 0;16<u.length&&(u=h(u,8*r.length));for(r=0;16>r;r+=1)w[r]=u[r]^909522486,z[r]=u[r]^1549556828;t=h(w.concat(l(t)),512+8*t.length);return k(h(z.concat(t),640))}function q(r){var t="",u;for(u=0;u<r.length;u+=1){var w=r.charCodeAt(u);t+="0123456789abcdef".charAt(w>>>4&15)+"0123456789abcdef".charAt(w&15)}return t}function v(r,t,u){t?u?r=p(unescape(encodeURIComponent(t)),unescape(encodeURIComponent(r))):(r=p(unescape(encodeURIComponent(t)),
...
h),5);case 5:r=u.yieldResult,v&&v.forEach(function(w){return w.resolve(r)});case 3:u.enterFinallyBlock();delete e[m];delete f[m];u.leaveFinallyBlock(0);break;case 2:t=u.enterCatchBlock(),v&&v.forEach(function(w){return w.reject(t)}),u.jumpTo(3)}})},c)})}}
...
(function(b){function c(){null==b.pageTextPositions&&(b.pageTextPositions=[]);return b.pageTextPositions}function d(q,v){var r=c();try{var t=v&&"object"===typeof v?Object.assign({},v):v;if(t&&"object"===typeof t){t.page=Number(q+1);var u=r[q];u&&u.positions&&t.positions?t.positions=u.positions.concat(t.positions):u&&u.positions&&(t.positions=u.positions);null!=l?t.realPage=Number(l):u&&u.realPage&&(t.realPage=u.realPage);u&&Object.keys(u).forEach(function(w){"page"===w||"realPage"===w||"positions"===
w||w in t||(t[w]=u[w])})}r[q]=t;return!0}catch(w){return console.error("writeToTarget error",w),!1}}function e(q,v,r){if(!q||0===q.length)return null;for(var t=q[0].left,u=q[0].top,w=q[0].right,z=q[0].bottom,A="",F=0;F<q.length;F++){var C=q[F];t=Math.min(t,C.left);u=Math.min(u,C.top);w=Math.max(w,C.right);z=Math.max(z,C.bottom);A+=C.text||""}F=t/v;u/=r;w/=v;r=z/r;r=[F,r,w,r,w,u,F,u];z=[];for(F=0;F<q.length;F++)z.push(q[F].width/v);if(!A||0===A.trim().length)return null;q=r.concat(z);return{w:A,p:q}}
function f(q){b._pageReaderExtracted||(b._pageReaderExtracted={});q=Array.isArray(q)?q:[q];for(var v=0,r=0;r<q.length;r++){var t=q[r];if(t&&!(1>t)&&!b._pageReaderExtracted[t])if(b._pageReaderExtracted[t]=!0,window._getPage&&"function"===typeof window._getPage)try{var u=window._getPage(t-1);if(u){var w=null;if(u.items&&Array.isArray(u.items)){w=u.items;for(var z=window.readerConfig.pageConfig.pageWidth,A=window.readerConfig.pageConfig.pageHeight,F=0,C=0;C<w.length;C++){var K=w[C];if(K&&"text"===K.type&&
K.positionText&&K.style){var M=K,I=t,G=z,O=A,L=c();b.pageTextPositions||(b.pageTextPositions=[]);var J=M;if(J&&J.positionText&&J.style){M=[];var Q=parseFloat(J.style.left)||0,U=parseFloat(J.style.top)||0,T=J.positionText;for(J=0;J<T.length;J++){var S=T[J];if(S&&S.rowText&&0!==S.rowText.length){for(var ia=S.rowText,W=[],ea=null,ma=0;ma<ia.length;ma++){var P=ia[ma];if(P&&P.text){var ja=Q+(P.left||0),na=U+(P.top||0),aa=P.width||0,R=P.height||0,fa=ja+aa,ka=!1;null!==ea&&ja-ea>.5*aa&&(ka=!0);if(ka&&0<
W.length){var ba=e(W,G,O);ba&&M.push(ba);W=[]}W.push({text:P.text,left:ja,top:na,width:aa,height:R,right:fa,bottom:na+R});ea=fa}}0<W.length&&(ba=e(W,G,O))&&M.push(ba)}}var X=M}else X=[];if(0!==X.length){G=I-1;var ca=L[G];ca?(ca.positions&&Array.isArray(ca.positions)?L[G].positions=ca.positions.concat(X):L[G].positions=X,L[G].page=I):L[G]={page:I,positions:X}}F++}}v+=F;0<F?console.log("PageTextExtractor: \u6210\u529f\u63d0\u53d6\u5e76\u6dfb\u52a0 "+F+" \u4e2a\u6587\u672c\u914d\u7f6e\u5230 positionForPages (\u9875\u9762 "+
...
t=function(){var w,z,A,F;return $jscomp.asyncExecutePromiseGeneratorProgram(function(C){switch(C.nextAddress){case 1:return C.setCatchFinallyBlocks(2,3),w=String.format(bookConfig.searchPositionJS,v),1<v&&(w=w.replace("[1]","["+v+"]")),z=/\.*\/?(\w+\/)*\w+(\[|\()?\d+(\]|\))?\.js/gi,A=/\.*\/?(\w+\/)*\w+?\.js/gi,w.match(z)||w.match(A)?C.yield(getArticleImage(fixURLValue(w)),5):C.return(!1);case 5:return(w=C.yieldResult)?C.yield(h(q,w,v),6):C.return(!1);case 6:return b._positionScriptLoaded[v]=!0,C.return(!0);
case 3:C.enterFinallyBlock();delete b._positionScriptLoadPromises[v];C.leaveFinallyBlock(0);break;case 2:return F=C.enterCatchBlock(),console.error("loadPagePositionScript: \u52a0\u8f7d\u5931\u8d25",F),C.return(!1)}})}();b._positionScriptLoadPromises[v]=t;return u.return(t)})}function h(q,v,r){var t;return $jscomp.asyncExecutePromiseGeneratorProgram(function(u){t=function(){var w,z,A,F,C,K,M,I;return $jscomp.asyncExecutePromiseGeneratorProgram(function(G){switch(G.nextAddress){case 1:k=q;l=r;if(w=
"undefined"!==typeof location&&"file:"===location.protocol){G.jumpTo(2);break}G.setCatchFinallyBlocks(3);return G.yield(fetch(v),5);case 5:z=G.yieldResult;if(!z.ok){console.warn("fetch returned non-ok",z.status,v);G.jumpTo(6);break}return G.yield(z.text(),7);case 7:return A=G.yieldResult,F=A.match(/positionForPages\[(\d+)\]/),C=A,F&&(C=C.replace(new RegExp("positionForPages\\["+F[1]+"\\]","g"),"positionForPages["+(q-1)+"]")),C=C.replace(/("page"\s*:\s*)"?\d+"?/g,"$1"+q),K="undefined"!==typeof window?
window:"undefined"!==typeof b?b:null,K&&K.document?G.yield(new Promise(function(O,L){var J="";try{var Q=new Blob([C],{type:"application/javascript;charset=utf-8"});J=URL.createObjectURL(Q)}catch(U){l=k=null;L(U);return}Q=K.document.createElement("script");Q.dataset.positionSource=v;Q.onload=function(){if(J)try{URL.revokeObjectURL(J)}catch(U){}setTimeout(function(){l=k=null;O()},0)};Q.onerror=function(){if(J)try{URL.revokeObjectURL(J)}catch(U){}l=k=null;L(Error("Blob script load failed: "+v))};Q.src=
J;K.document.head.appendChild(Q)}),8):(console.warn("PageTextExtractor: \u65e0 document\uff0c\u65e0\u6cd5\u6267\u884c\u4f4d\u7f6e\u811a\u672c"),l=k=null,G.return());case 8:return G.return();case 6:G.leaveTryBlock(2);break;case 3:M=G.enterCatchBlock(),console.warn("fetch failed, fallback to script tag (likely file://). Error:",M&&M.message);case 2:return I="undefined"!==typeof window?window:"undefined"!==typeof b?b:null,I?G.yield(new Promise(function(O,L){var J=I.document.createElement("script");J.dataset.positionSource=
v;J.onload=function(){setTimeout(function(){l=k=null;O()},0)};J.onerror=function(Q){l=k=null;console.log("Script load failed:",v,Q);L(Error("Script load failed: "+v))};J.src=v;I.document.head.appendChild(J)}),0):(console.log("\u65e0\u6cd5\u627e\u5230 window \u6216 global \u5bf9\u8c61"),G.return())}})};m=m.then(function(){return t()}).catch(function(w){console.log("queue error:",w&&w.message)});return u.return(m)})}"undefined"!==typeof b&&null==b.pageTextPositions&&(b.pageTextPositions=[]);var k=null,
...
(b._positionScriptLoadPromises={});b.extractPageTextConfigs=f;b.loadPageTextInfo=function(q){var v,r,t,u,w,z,A,F;return $jscomp.asyncExecutePromiseGeneratorProgram(function(C){switch(C.nextAddress){case 1:b._positionScriptLoaded||(b._positionScriptLoaded={}),b._pageReaderExtracted||(b._pageReaderExtracted={}),b.pageTextPositions||(b.pageTextPositions=[]),v=Array.isArray(q)?q:[q],r=[],t=!1,u=0;case 2:if(!(u<v.length)){C.jumpTo(4);break}w=v[u];if(!w||1>w){C.jumpTo(3);break}z={pageIndex:w,hasText:!1,
positionCount:0};C.setCatchFinallyBlocks(5);return C.yield(g(w),7);case 7:b._pageReaderExtracted[w]||f(w);(A=c()[w-1])&&A.page===w&&A.positions&&Array.isArray(A.positions)&&0<A.positions.length&&(z.hasText=!0,z.positionCount=A.positions.length,t=!0);C.leaveTryBlock(6);break;case 5:F=C.enterCatchBlock(),console.log("loadPageTextInfo: \u52a0\u8f7d\u9875\u9762 "+w+" \u7684\u6587\u672c\u4fe1\u606f\u65f6\u51fa\u9519",F);case 6:r.push(z);case 3:u++;C.jumpTo(2);break;case 4:return C.return({hasText:t,pageResults:r})}})};
b.hasPageText=function(q){b.pageTextPositions||(b.pageTextPositions=[]);var v=!Array.isArray(q),r=[],t=!1;q=$jscomp.makeIterator(v?[q]:q);for(var u=q.next();!u.done;u=q.next())if(u=u.value,!u||1>u)v||r.push({pageIndex:u,hasText:!1,positionCount:0});else{var w={pageIndex:u,hasText:!1,positionCount:0},z=u-1;(z=c()[z])&&z.page===u&&z.positions&&Array.isArray(z.positions)&&0<z.positions.length&&(w.hasText=!0,w.positionCount=z.positions.length,t=!0);if(v)return w.hasText;r.push(w)}return{hasText:t,pageResults:r}};
...
SET_AD_BANNER:"staticAd",ADD_AD:"staticAd",SET_BOOK_LOGO:"appLogoIcon",SET_LOGO_LINK:"appLogoLinkURL",OPEN_AUTO_FLIP:"AutoPlayButtonVisible;autoPlayAutoStart;autoPlayDuration;autoPlayLoopCount",OTHERS_DOWNLOAD_FILE:"DownloadButtonVisible;DownloadURL",OTHERS_DOWNLOAD_ATTACHMENT:"downloadAttachments",COPY_TEXT:"SelectTextButtonVisible",SET_VIDEO_LIST_BUTTON:"VideoButtonVisible",SET_BACKGROUND_IMG:"backGroundImgURL;backgroundOpacity;backgroundPosition;backgroundScene",SET_BACKGROUND_MUSIC:"BackgroundSoundButtonVisible;BackgroundSoundURL;BackgroundSoundLoop",
...
function checkPermission(b,c){if(!c)return!1;if(Array.isArray(c))for(var d=0;d<c.length;d++){var e=parsePowerToken(c[d]);if(e&&1===e.limitId){var f=newRestrictedMap[e.key];if(f&&f.split(";").includes(b)&&0===e.value)return!0}}for(var g in restrictedMap)if(c.includes(g)&&restrictedMap[g].split(";").includes(b))return!0;return!1}
function checkBookConfigRestrictedKey(b,c){var d,e,f,g,h,k,l,m,p=function(){return(null==(d=window.tmpBookConfig)?void 0:null==(e=d.power_info)?void 0:e.power)||(null==(f=window.bookConfig)?void 0:null==(g=f.power_info)?void 0:g.power)||(null==(h=window.UserInfoUtils)?void 0:null==(l=(k=h).getDecryptedPower)?void 0:l.call(k))||(Array.isArray(null==(m=window.userInfo)?void 0:m.power)?window.userInfo.power:null)||null},q=function(C){var K;if(!("appLogoIcon"===b&&0<Number(null==(K=window.userInfo)?void 0:
K.ai))){if(checkPermission(b,C))return specialHandlers[b]?specialHandlers[b]():c;if(isRecastiaDomain()&&isRecastiaFreeUser()){if("appLogoIcon"===b)return getRecastiaAppLogoIcon();if("appLogoLinkURL"===b)return getRecastiaAppLogoLinkURL()}if("appLogoIcon"===b&&(C=String(window.bookConfig&&window.bookConfig.appLogoIcon||window.tmpBookConfig&&window.tmpBookConfig.appLogoIcon||("undefined"!==typeof c?c:"")).trim(),"string"==typeof C&&(C=C.replaceAll("\\/","/",!0),C=C.replaceAll('\\"','"')),/^(\.\.\/){2}booklogo\.png([?#].*)?$/.test(C)))return""}},
v,r,t,u,w,z,A,F=(null==(v=window.tmpBookConfig)?void 0:null==(r=v.power_info)?void 0:r.power)||(null==(t=window.bookConfig)?void 0:null==(u=t.power_info)?void 0:u.power)||(null==(w=window.UserInfoUtils)?void 0:null==(z=w.getDecryptedPower)?void 0:z.call(w))||(Array.isArray(null==(A=window.userInfo)?void 0:A.power)?window.userInfo.power:null);if(!F&&isRecastiaDomain()&&window.userInfo&&"c"in window.userInfo)return q(p());if(!F&&window.eventEmitter&&"function"===typeof window.eventEmitter.on)window.eventEmitter.on("loadUserInfo",
function(C){return q(p())});return q(p())}checkReportConfig=function(){changeBookConfigValue("EnableReportButton",getConfigValue("EnableReportButton",!1))};var tmpBookConfig={};
...
return"issuu"==tmpBookConfig.FlipStyle?m.yield(loadCSS(tmpBookConfig.UIBaseURL+"style/adaptivebook.min.css"),7):m.yield(loadCSS(tmpBookConfig.UIBaseURL+"style/flipbook.min.css"),7);case 7:return checkPageEditorConfig(),recordError(),k=Module._getVerifyString(),l=UTF8ToString(k),Module._free(k),m.yield(runDecryptedScript(l),0)}})};
...
var VERSION_NAME="7.0.0",BUILD_DATE="2026091501",BookType={normal_book:0,single_book:1,slide_book:3,singleSlide_book:6,catalog_book:7,singleCatalog_book:8,documentView_book:9,singleDocumentView_book:10,card_book:11,invert_book:12},normalBookStatu={book_statu_ready:0,book_statu_auto_flip:1,book_statu_mouse_flip:2,book_statu_mag_flip:3},singleBookStatu={book_statu_ready:0,book_statu_auto_flip:1,book_statu_mouse_flip:2,book_statu_mag_flip:3},bookCorner={top_left:0,top_right:1,bottom_left:2,bottom_right:3},
...
function getArticleEditor(){function b(u){if(window.isExecuteGetInverseEditor)var w=window.setInterval(function(){if(window.runArticleEditor||window.inverseEditor)window.clearInterval(w),u()},10);else window.isExecuteGetInverseEditor=!0,f(),window.articleListConfig?(e(window.articleListConfig),u(),window.runArticleEditor&&delete window.runArticleEditor):bookConfig.articleListPath&&c(bookConfig.articleListPath,function(z){d(z,u)},u,"")}function c(u,w,z,A,F){var C=new XMLHttpRequest;C.responseType=
void 0===A?"json":A;C.open("GET",u);C.send();C.onreadystatechange=function(){4===C.readyState&&(200===C.status||304===C.status?w&&w(C):"bookinfo"===F&&w?w():z&&z(w))};C.error=function(){z&&z(w)}}function d(u,w){t&&(clearTimeout(t),t=null);if(window.Module.isReady){var z=allocateUTF8(u.responseText),A=Module._DeString(z),F=UTF8ToString(A);F=eval(F);Module._free(z);Module._FreeMemory(A);e(F);w();window.runArticleEditor&&delete window.runArticleEditor}else t=setTimeout(function(){d(u,w)},100)}function e(u){(window.articleListConfig=
u)?g(u):window.inverseEditor=[]}function f(){(bookConfig.articleConfigPath||bookConfig.bookArticleConfigPath||bookConfig.periodsConfigPath&&window.book_visit&&window.book_visit.periodicalId||bookConfig.userArticleConfigPath)&&p(function(u){window.articleConfig=u.response})}function g(u){for(var w=[],z=window.bookConfig.totalPageCount,A=window.htmlConfig?window.htmlConfig.search_pages:[],F=0;F<z;F++){for(var C=A&&A.length&&A[F]?A[F].index:F,K=[],M=0;M<u.length;M++)(u[M].articles?u[M].articles:[]).forEach(function(I){if(I.isShowLinkSplited){if(I.articleTextList&&
I.articleTextList.length){var G=l(I.articleTextList,C);console.log(G,C);I=k(I);for(var O=0;O<G.length;O++){var L=h(I,G[O]);K.push(L)}}}else{G="";if(""===I.activePage||void 0===I.activePage||I.activePage&&(-2===parseFloat(I.activePage)||parseFloat(I.activePage)===C))a:{G=C;O={};I.collapseArea&&(O=JSON.parse(I.collapseArea));if(O[G])G={rect:O[G]};else{if(!I.articleTextList||!I.articleTextList.length){G="";break a}G=m(I.articleTextList,G)}G="[object Object]"===Object.prototype.toString.call(G)?{tannoName:"link1",
x:G.rect.x,y:G.rect.y,width:G.rect.width,height:G.rect.height,rotation:"0",reflection:"false",reflectionType:"0",reflectionAlpha:"0",pageWidth:G.rect.pageWidth,pageHeight:G.rect.pageHeight}:""}G&&I.articleTextList&&I.articleTextList.length&&(I=k(I),L=h(I,G),K.push(L))}});w.push(K)}console.log("currentPageEditor",JSON.parse(JSON.stringify(w)));window.inverseEditor=w}function h(u,w){window.articleConfig||(window.articleConfig={});window.articleConfig.hotArea||(window.articleConfig.hotArea={overColor:"#4997ee",
...
pageViewedBool:"true",ellipseH:"0",ellipseW:"0",location:w,hint:{hintShapeColor:"0",hintShapeColor2:"8388736",hintShapeAlpha:"1",hintW:"0",hintH:"0",hintAuto:"true",hintShapeType:"2",text:""},shadow:{hasDropShadow:"false",shadowDistance:"4",shadowAngle:"270",shadowColor:"0",shadowAlpha:"0.6",shadowBlurX:"4",shadowBlurY:"4"},highlightsBool:"false",linkStatus:"1",mouseOver:"false",borderColor:"16737792"}}function k(u){u=JSON.parse(JSON.stringify(u));u.articleTextList.map(function(w){"text"===w.type&&
(w.text=w.text.replace(/\n[ ]+/g,"<br>&emsp;&emsp;"));return w});return{articleId:u.articleId,newTime:u.newTime,title:u.title,subTitle:u.subTitle,author:u.author,categoryId:u.categoryId,articleTextList:u.articleTextList}}function l(u,w){var z=[];u.forEach(function(A){-1!==w&&(A.pageIndex===w||A.mergeList&&A.mergeList.length&&A.mergeList.filter(function(F){return F.pageIndex===w}).length)&&(A.mergeList&&A.mergeList.length?(A=l(A.mergeList,w),A.length&&(z=[].concat($jscomp.arrayFromIterable(z),$jscomp.arrayFromIterable(A)))):
z.push(A.rect))});return z}function m(u,w){var z="";u.forEach(function(A){if(-1!==w&&(A.pageIndex===w||A.mergeList&&A.mergeList.length&&A.mergeList.filter(function(C){return C.pageIndex===w}).length))if(""===z)z=A.mergeList&&A.mergeList.length?m(A.mergeList,w):JSON.parse(JSON.stringify(A));else{if(A.mergeList&&A.mergeList.length){var F=[z].concat(A.mergeList);z=m(F,w)}z.rect.x>A.rect.x&&(z.rect.x=A.rect.x);z.rect.y>A.rect.y&&(z.rect.y=A.rect.y);z.rect.endX<A.rect.endX&&(z.rect.endX=A.rect.endX);z.rect.endY<
A.rect.endY&&(z.rect.endY=A.rect.endY);z.rect.width=z.rect.endX-z.rect.x;z.rect.height=z.rect.endY-z.rect.y}});return z}function p(u){bookConfig.articleConfigPath?c(bookConfig.articleConfigPath,u,q):q(u)}function q(u){bookConfig.bookArticleConfigPath?c(bookConfig.bookArticleConfigPath,u,v):v(u)}function v(u){if(bookConfig.periodsConfigPath&&window.book_visit&&window.book_visit.periodicalId){var w=bookConfig.periodsConfigPath;w=w.replace("%periodicalId%",window.book_visit.periodicalId);c(w,u,r)}else r(u)}
function r(u){bookConfig.userArticleConfigPath?c(bookConfig.userArticleConfigPath,u):u&&u()}var t;return $jscomp.asyncExecutePromiseGeneratorProgram(function(u){return u.return(new Promise(function(w,z){window.templeteName&&!window.templeteName.toLowerCase().match(/article/)?w():window.runArticleEditor||window.inverseEditor?w():(console.log("create getArticleEditor one time"),bookConfig.articleListPath?(z=bookConfig.bookBaseURL)?(z.endsWith("/")||(z+="/"),c(z+"bookinfo.js",function(A){A&&A.response&&
(eval(A.response),window.book_visit=book_visit);b(function(){window.runArticleEditor=1;w()})},"","text","bookinfo")):b(function(){window.runArticleEditor=1;w()}):(window.runArticleEditor=1,w(),window.runArticleEditor&&delete window.runArticleEditor))}))})}
...
function canvasReload(b,c,d,e){var f=b.width,g=b.height;c=Math.round(c);d=Math.round(d);var h=f/c,k=g/d,l=Math.ceil(h/2),m=Math.ceil(k/2),p=b.getContext("2d",{willReadFrequently:!0}),q=p.getImageData(0,0,f,g),v=p.createImageData(c,d);q=q.data;for(var r=v.data,t=0;t<d;t++)for(var u=0;u<c;u++){for(var w=4*(u+t*c),z,A=0,F=0,C=0,K=0,M=0,I=0,G=(t+.5)*k,O=Math.ceil((t+1)*k),L=Math.floor(t*k);L<O;L++){var J=Math.abs(G-(L+.5))/m,Q=(u+.5)*h;J*=J;for(var U=Math.ceil((u+1)*h),T=Math.floor(u*h);T<U;T++)if(z=
Math.abs(Q-(T+.5))/l,z=Math.sqrt(J+z*z),!(1<=z)){z=2*z*z*z-3*z*z+1;var S=4*(T+L*f);I+=z*q[S+3];F+=z;255>q[S+3]&&(z=z*q[S+3]/250);C+=z*q[S];K+=z*q[S+1];M+=z*q[S+2];A+=z}}r[w]=C/A;r[w+1]=K/A;r[w+2]=M/A;r[w+3]=I/F}!0===e?(b.width=c,b.height=d):p.clearRect(0,0,f,g);p.putImageData(v,0,0)}
...
2-c.width/2,b.canvas.height/2-c.height/2,c.rotation,c)):(e=function(k,l,m,p,q){q=void 0===q?!1:q;var v=h[m],r=Math.abs(l-k);if(!(0>=r)){p=p?v.width:v.height;l=0;if(r>=p)for(l=Math.floor((r+c.spacing)/(p+c.spacing));0<l&&!(l*p+(l-1)*c.spacing<=r);)l--;if(!(0>=l)){r=1<l?(r-l*p)/(l-1):0;for(var t=0;t<l;t++){var u=q?k-t*(p+r):k+t*(p+r),w=void 0,z=void 0;switch(m){case "top":w=u+(v.width-c.width)/2;z=(v.height-c.height)/2+f;break;case "right":w=b.canvas.width-(c.width+v.width)/2-f;z=u+(v.height-c.height)/
2;break;case "bottom":w=u+(v.width-c.width)/2;z=b.canvas.height-(c.height+v.height)/2-f;break;case "left":w=(v.width-c.width)/2+f,z=u+(v.height-c.height)/2}WatermarkStrategy.prototype.drawSingleWatermark.call(d,b,w,z,g[m],c,q)}}}},e(f,b.canvas.width-h.right.width-f,"top",!0,!1),e(f,b.canvas.height-h.bottom.height-f,"right",!1,!1),e(h.left.width,b.canvas.width-f,"bottom",!0,!1),e(h.top.height,b.canvas.height-f,"left",!1,!1))};var WatermarkStrategyFactory=function(){};
...
b;this.flippingTime=1E3*bookConfig.flippingTime},flipIntervalTmp:function(b,c,d,e){if(b){this.book.flipping=!0;b.flipping=!0;var f=.05;if(isIE()||isFirefox())f=0;b.setFlipOriginPoint(e);b.coordinate||(b.coordinate=b.startPoint);var g=b.coordinate.x,h=b.coordinate.y,k,l=this.flippingTime;l=l*Math.abs(b.toPoint.x-g)/Math.abs(b.toPoint.x-b.startPoint.x);e=isAndroidWeChat()||isAndroidDefault()||isIE()||isFirefox()?function(){var p=0;k=function(){m(p,25,"Sine");p++}.interval(this,l/25)}.bind(this):function(){k=
function(p,q){m(p,q,"Sine")}.animation(this,l)}.bind(this);var m=function(p,q,v){if(!b)return!1;var r=b.pageWidth,t=b.pageHeight,u=$.easing["easeInOut"+v],w=$.easing["easeOut"+v];v=w(null,p,g,b.toPoint.x-g,q);w=w(null,p,h,b.toPoint.y-h,q);b.dragMoveToFlip||(v=u(null,p,g,b.toPoint.x-g,q),w=bookConfig.FlipDirection?f*Math.sqrt(t*t-v*v):t-f*Math.sqrt(r*r-v*v));p<q?this.flipToPoint(b,c,d,b.fromPoint,{x:v,y:w}):(this.flipToPoint(b,c,d,b.fromPoint,b.toPoint),this.book.afterFlipTo(b,d),BookEvent.trigger("afterFlipPage",
...
l/25)}.bind(this):function(){k=function(p,q){m(p,q,"Sine")}.animation(this,l)}.bind(this);var m=function(p,q,v){if(!b)return!1;var r=b.pageWidth,t=b.pageHeight,u=$.easing["easeInOut"+v],w=$.easing["easeOut"+v];v=w(null,p,g,b.toPoint.x-g,q);w=w(null,p,h,b.toPoint.y-h,q);b.dragMoveToFlip||(v=u(null,p,g,b.toPoint.x-g,q),w=bookConfig.FlipDirection?f*Math.sqrt(t*t-v*v):t-f*Math.sqrt(r*r-v*v));p<q?this.flipToPoint(b,c,d,b.fromPoint,{x:v,y:w}):(this.flipToPoint(b,c,d,b.fromPoint,b.toPoint),this.book.afterFlipTo(b,
